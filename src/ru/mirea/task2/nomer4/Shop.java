package ru.mirea.task2.nomer4;

import ru.mirea.task2.nomer4.ShopHelper;
...
class ShopTest{
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Введите кол-во пк: ");
        int count = sc.nextInt();
        Computer[] computers = new Computer[count];
        for(int i = 0; i < count; i++){
            System.out.println("Введите параметры пк: ");
            String name = sc.next();
            int cost = sc.nextInt();
        ...
        Computer c1 = new Computer("model_one", 240);
        Computer c2 = new Computer("model_x", 535123);
        shop1.add(c1);
        System.out.println(shop1);
        shop1.add(c2);
        System.out.println(shop1);
        ...
        System.out.println(shop1.findByName("model_x"));
        System.out.println(shop1.findByName("xxx"));
        sc.close();
    }
}